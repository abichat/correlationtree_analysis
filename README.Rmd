...
This folder contains scripts for generating forests of trees, compute the distances (BHV and RF) between them and apply PCoA. 

Subfolders correspond to the dataset used to generate the forests: Chaillou, Chlamydiae, Ravel and Zeller.
