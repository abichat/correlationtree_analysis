...
The parametric simulation mimics the scheme used in Xiao et al. (2018). It fits a negative-binomial Dirichlet-Multinomial (DM) distibution on Wu dataset and generates new differentially abundance datasets.
